...
| FR-09 | The drone's planner SHALL treat each turbine's precomputed swept-disk keep-out volume as a hard no-fly constraint; the planner SHALL NOT rely on instantaneous collision detection alone. | PIL-2, PIL-6 | SLICE-2 | Proposed | KPI-04 (collision-free-flight rate) + zero keep-out intrusions in the scenario suite |
